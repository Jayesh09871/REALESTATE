...
export const updateAppointmentStatus = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Viewing Appointment ${status.charAt(0).toUpperCase() + status.slice(1)} - REALSTATE`,
...
export const scheduleViewing = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: req.user.email,
      subject: "Viewing Scheduled - REALSTATE",
...
export const cancelAppointment = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: 'Appointment Cancelled - REALSTATE',
      html: `
...
export const updateAppointmentMeetingLink = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: "Meeting Link Updated - REALSTATE",
      html: `
